...
SARIMA model allows more possibility to consider the seasonal component, the ARIMA model takes the seasonal component as constant. Thus, SARIMA model is more preferable to model.
